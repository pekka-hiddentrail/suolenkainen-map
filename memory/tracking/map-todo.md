# Suolenkainen's Map Todo

Active practical checklist and future-work queue for map work. Use this for concrete next actions; keep `open-obligations.md` as the fuller debt and return-condition ledger.

Todo types:

- Triggered: has a return condition, such as a tile, feature, color number, edge, or keyword.
- Unscheduled: has no trigger yet and waits until Maintenance or the user chooses it.
- Next-session: should be checked before or during the next session.
...
- [x] When silver grid bleed, black warning bleed, AIKA technical energy, safety lines, bleed-prevention wall, or color 6 appears, review the S003 T003/T001 two-way bleed. (Reviewed after S005: Brown rolled 6 in S005's Awakening/Cartography draw, a color-6 pressure. T005 doesn't touch T001 or T003 — it's only adjacent to T004 — so the existing T003/T001 bleed record stands unchanged; no complication introduced. Reviewed again as S006's own Chronicle Maintenance action: unlike S005, this time the review actually changes something — T006/Shoreline was created directly between T001 and T003, shares T003's black-warning-bleed tag, and pushes a silver hexagon onto T001's AIKA text. The old two-way bleed now has a third participant with a body of its own; see K033 Hex Tideline for the still-open question of which color governs it.)
...
- [x] Adopt S003 Force clarification: rename Collateral to Trace and clarify On Neighbor + Bleed + Marks edge/contact.
- [x] Adopt Seed clarification: Seed creates triggered or unscheduled future-work items in the todo queue.
- [x] Update Chronicle Maintenance 4 to Todo list / future-work queue.
