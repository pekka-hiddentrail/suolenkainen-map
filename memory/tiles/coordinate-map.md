...
| T004 |  | [-1,-1] | Created by S004 as the last free coordinate before occupied [0,0] during walk-back; exact physical edge placement still needs confirmation |
...
- Keep this file synchronized with `tile-data.md` whenever Awakening creates, targets, or repositions a tile.
