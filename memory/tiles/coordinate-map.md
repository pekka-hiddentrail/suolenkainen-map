...
| T005 | The Monster | [-1,-1] | Touches T004 directly on T005's SE / T004's NW edge. Raw Awakening target was already adjacent to T004 despite being empty, so no walk-back steps were needed (see Notes below) |
